...
let MarketingService = class MarketingService {
    storyRepo;
    blogRepo;
    constructor(storyRepo, blogRepo) {
...
exports.MarketingService = MarketingService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(success_story_entity_1.SuccessStoryEntity)),
    __param(1, (0, typeorm_1.InjectRepository)(blog_post_entity_1.BlogPostEntity)),
