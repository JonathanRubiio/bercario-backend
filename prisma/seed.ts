...
async function main() {
  ...
  await prisma.businessProfile.create({
    data: {
      ...
      products: initialProfile.products as any,
      testimonials: initialProfile.testimonials as any,
      faqs: initialProfile.faqs as any,
      gallery: initialProfile.gallery as any,
      sections: initialProfile.sections as any,
    },
  });
